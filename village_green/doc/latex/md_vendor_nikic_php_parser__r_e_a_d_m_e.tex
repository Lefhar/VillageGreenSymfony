...
\href{https://github.com/nikic/PHP-Parser/tree/master/doc}{\texttt{ {\bfseries{Documentation for version 4.\+x}}}} (stable; for running on PHP \texorpdfstring{$>$}{>}= 7.\+0; for parsing PHP 5.\+2 to PHP 8.\+0).

\href{https://github.com/nikic/PHP-Parser/tree/3.x/doc}{\texttt{ Documentation for version 3.\+x}} (unsupported; for running on PHP \texorpdfstring{$>$}{>}= 5.\+5; for parsing PHP 5.\+2 to PHP 7.\+2).\hypertarget{md_vendor_nikic_php_parser__r_e_a_d_m_e_autotoc_md546}{}\doxysection{Features}\label{md_vendor_nikic_php_parser__r_e_a_d_m_e_autotoc_md546}
...
\end{DoxyItemize}\hypertarget{md_vendor_nikic_php_parser__r_e_a_d_m_e_autotoc_md547}{}\doxysection{Quick Start}\label{md_vendor_nikic_php_parser__r_e_a_d_m_e_autotoc_md547}
...
\begin{DoxyCode}{0}
\DoxyCodeLine{use \mbox{\hyperlink{interface_php_parser_1_1_node}{PhpParser\(\backslash\)Node}};}
...
For a more comprehensive introduction, see the documentation.\hypertarget{md_vendor_nikic_php_parser__r_e_a_d_m_e_autotoc_md548}{}\doxysection{Documentation}\label{md_vendor_nikic_php_parser__r_e_a_d_m_e_autotoc_md548}
